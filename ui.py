...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(150, 125, font=('Arial', 20, 'italic'), width=280, fill=THEME_COLOR)
    ...
    def get_next(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text=f"You've reached the end of the quiz with a score of {self.quiz.score}/10")
